...
The device was running an older Tolino firmware on Android 4.4.2, so I used the Tolino debug menu code for that firmware generation to enable debug mode from the search field.
